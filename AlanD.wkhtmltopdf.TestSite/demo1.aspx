<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="demo1.aspx.cs" Inherits="AlanD.wkhtmltopdf.TestSite.demo1" %>
...
<body>
    <form id="form1" runat="server">
        <h2>Demo1 - Output 3 url's as one or separate PDF's</h2>
        <h3>With manually configured PdfGenerator</h3>
        <table>
            <tr>
                <td><asp:Label ID="lbl_source_1" runat="server" Text="URL Source" AssociatedControlID="fld_source_1"></asp:Label></td>
